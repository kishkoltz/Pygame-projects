...
def settiles():
    ...
    foreground['rect'] = (WINDOWWIDTH/2 - 150 - crosshairx,
        WINDOWHEIGHT/2 - 150 - crosshairy, 300, 300)
    closeMidground['rect'] = (WINDOWWIDTH/2 - 120 - int(0.8 * crosshairx),
        WINDOWHEIGHT/2 - 120 - int(0.8 * crosshairy), 240, 240)
    midground['rect'] = (WINDOWWIDTH/2 - 90 - int(0.6 * crosshairx),
        WINDOWHEIGHT/2 - 90 - int(0.6 * crosshairy), 180, 180)
    farMidground['rect'] = (WINDOWWIDTH/2 - 60 - int(0.4 * crosshairx),
        WINDOWHEIGHT/2 - 60 - int(0.4 * crosshairy), 120, 120)
    background['rect'] = (WINDOWWIDTH/2 - 30 - int(0.2 * crosshairx),
        WINDOWHEIGHT/2 - 30 - int(0.2 * crosshairy), 60, 60)
